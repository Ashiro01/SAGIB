    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entidad_afectada', models.CharField(blank=True, max_length=100, null=True, verbose_name='Entidad Afectada')),
                ('id_entidad_afectada', models.PositiveIntegerField(blank=True, null=True, verbose_name='ID de la Entidad Afectada')),
